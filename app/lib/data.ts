import mysql, { ConnectionOptions, RowDataPacket, ResultSetHeader } from 'mysql2/promise';
...
export async function addQuestion(surveyid:number,question:string,responses:string) {
...
export async function createSurvey(title:string,prompt:string) : Promise<number> {
